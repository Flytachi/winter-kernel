...
final class SwooleEngine implements ProcessEngine
{
    ...
    public function requestStop(bool $interrupt): void
    {
        ...
        // Arm the grace backstop BEFORE the cancel. Arming a timer in the same
        // handler *after* Coroutine::cancel() swallows the body's pending resume,
        // freezing it until the timer fires — so a fast IDLE drain would instead
        // always wait the full grace. Order matters here.
